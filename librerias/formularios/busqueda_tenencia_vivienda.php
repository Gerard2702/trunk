	 ...
	 <div class="container">
		...
		<div class="tab-content">
  			<div class="tab-pane active">
  				...
  				<p><h3>Busqueda por Tenencia de Vivienda</h3></p>
                <p><h4>Tenencia:</h4></p>
                <br>
                  ...
                  <div class="row">
                    <div class="col-md-8">
                        <label class="checkbox-inline">
                          <input type="checkbox" id="Propia" value="Propia"> Propia
                        </label>
                        <label class="checkbox-inline">
                          <input type="checkbox" id="Alquilada" value="Alquilada"> Alquilada
                        </label>
                        <label class="checkbox-inline">
                          <input type="checkbox" id="Colono/Guardian" value="Colono/Guardian"> Colono/Guardian
                        </label>
