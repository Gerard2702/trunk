...
-- Volcando estructura de base de datos para censo_nc
CREATE DATABASE IF NOT EXISTS `censo_nc` /*!40100 DEFAULT CHARACTER SET utf8 */;
USE `censo_nc`;
...
-- Volcando datos para la tabla censo_nc.religion: ~6 rows (aproximadamente)
...
-- Volcando datos para la tabla censo_nc.situacion: ~0 rows (aproximadamente)
...
-- Volcando datos para la tabla censo_nc.situacion_laboral: ~0 rows (aproximadamente)
...
-- Volcando datos para la tabla censo_nc.tenencia_vivienda: ~0 rows (aproximadamente)
...
-- Volcando datos para la tabla censo_nc.tipo_familia: ~2 rows (aproximadamente)
...
-- Volcando datos para la tabla censo_nc.tipo_letrina: ~0 rows (aproximadamente)
/*!40000 ALTER TABLE `tipo_letrina` DISABLE KEYS */;
INSERT INTO `tipo_letrina` (`id_tipoletrina`, `nombre`) VALUES
	(1, 'De lavar'),
	(2, 'Conectada a foza Septica'),
	(3, 'De lavar conectado a alcantarillado'),
	(4, 'Letrina de Hoyo Seco'),
	(5, 'Letrina Abonera'),
	(6, 'Otro tipo '),
	(7, 'No Aplica');
...
-- Volcando datos para la tabla censo_nc.usuarios: ~0 rows (aproximadamente)
...
CREATE TABLE IF NOT EXISTS `vivienda_ingreconomico` (
  ...
  `ingreso_economico_id_ingreso` int(11) NOT NULL,
  PRIMARY KEY (`id_vivienda_ingre`),
  KEY `fk_vivienda_ingreconomico_vivienda1_idx` (`vivienda_id_vivienda`),
  KEY `fk_vivienda_ingreconomico_ingreso_economico1_idx` (`ingreso_economico_id_ingreso`),
  CONSTRAINT `fk_vivienda_ingreconomico_ingreso_economico1` FOREIGN KEY (`ingreso_economico_id_ingreso`) REFERENCES `ingreso_economico` (`id_ingreso`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_vivienda_ingreconomico_vivienda1` FOREIGN KEY (`vivienda_id_vivienda`) REFERENCES `vivienda` (`id_vivienda`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE IF NOT EXISTS `vivienda_mascota` (
  `id_vivimascota` int(11) NOT NULL,
  `id_vivienda` int(11) NOT NULL,
